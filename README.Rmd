...
`morphospace` has been built to work with different types of geometric morphometrics data. Below, the general concept and capabilities of  `morphospace` are showcased using three data sets representing these types and various spatio-temporal scales that are typically addressed when studying evolutionary variation.
...
Since the use of templates for 3D shapes can be very time-consuming, it may be a good idea to experiment with the 'naked' configurations before producing the final plots.

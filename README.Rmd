...
Rr against taxonomic classification to assess patterns of intra- and/or interspecific variation.
...
- Introduction of box and violin plots for combining shape ordination axes with categorical variables via `plot_mspace`.

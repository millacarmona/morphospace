...
# a scale bar can be added (and changes introduced) by regenerating the "mspace" 
# object with plot_mspace
...
# * Note that the symbols in the legend are taken from proj_shapes and proj_groups 
